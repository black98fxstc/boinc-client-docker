...
RUN git clone --branch "${BOINC_VERSION}" https://github.com/BOINC/boinc.git; 
RUN  cd boinc; ./_autosetup; ./configure --enable-client --disable-manager --disable-server; make; cd ..; \
